...
export function salvarLocalStorage(chave, informação){
...
export function desenharProdutoCarrinhoSimples(idProduto, idContainerHtml, quantidadeProduto){
    ...
    'flex', 'bg-stone-200', 'rounded-lg',
    'p-1', 'relative', 'mb-2', 'w-96'];
    ...
    <div class='flex text-slate-950 items-end absolute bottom-0
        right-2 text-lg'>
